...
const globalCss = defineGlobalStyles({
  ...
  '.document-menu-item': {
    ...
    '&:hover .document-menu-item-title, &:has(a[aria-current="page"]) .document-menu-item-title': {
      color: 'var(--colors-g6)',
    },
    '&:hover .document-menu-item-delete-button': { opacity: '1' },
  },
  ...
  '.context-menu-icon': { fontSize: '13px' },
  ...
  '.workspace-drawer-icon': { fontSize: '10px' },
  '.workspace-drawer-actions': {
    display: 'flex',
    gap: '10px',
  },
  '.workspace-drawer-action-btn': {
    background: 'none',
    border: 'none',
    color: 'var(--colors-g3)',
    cursor: 'pointer',
  ...
  '.workspace-key-copy': {
    ...
    fontSize: '10px',
    padding: '0',
    '&:hover': { color: 'var(--colors-g4)' },
  },
  '.workspace-drawer-create-cta': {
    borderTop: '1px solid var(--colors-g2)',
    marginTop: '8px',
  },
